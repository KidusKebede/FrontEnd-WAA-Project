  ...
  return (
    <div>
      <form ref={from}>
        ...
        <input type="text" label={"properyType"} name={"propertyType"}></input>
        <label>Price: </label>
        <input type="text" label={"price"} name={"price"}></input>
        ...
        <input type="text" label={"homeType"} name={"homeType"}></input>
        <label>Location:</label>
        <input type="text" label={"location"} name={"location"}></input>
